...
//            listBoxCompanies.SelectedIndexChanged += listBoxCompanies_SelectedIndexChanged;
        ...
        private void listBoxCompanies_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            sql = "select case when venpaymentgroup<='' or venpaymentgroup is null then 'NO GROUP' else VENPAYMENTGROUP end from vendor group by case when venpaymentgroup<='' or venpaymentgroup is null then 'NO GROUP' else VENPAYMENTGROUP end";
